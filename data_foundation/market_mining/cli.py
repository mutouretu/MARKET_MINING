...
def show_config(
    config: Path = typer.Option(
        Path("data_foundation/configs/default.yaml"),
        "--config",
        "-c",
...
def build_fred_report(
    ...
    output: Path = typer.Option(
        Path("monitoring/reports/fred_macro_snapshot.html"),
        "--output",
        "-o",
...
def build_fred_macro_features(
    ...
    output_dir: Path = typer.Option(
        Path("feature_foundation/outputs"),
        "--output-dir",
...
def build_macro_features_command(
    fred_wide: Path = typer.Option(
        Path("feature_foundation/outputs/fred_macro_wide_daily.csv"),
        "--fred-wide",
        help="FRED macro wide daily CSV path.",
    ),
    usd_liquidity: Path = typer.Option(
        Path("feature_foundation/outputs/usd_liquidity_daily.csv"),
        "--usd-liquidity",
        help="USD liquidity daily CSV path.",
    ),
    stablecoins: Path = typer.Option(
        Path("feature_foundation/outputs/stablecoin_liquidity_daily.csv"),
        "--stablecoins",
        help="Stablecoin liquidity daily CSV path.",
    ),
    btc_market: Path = typer.Option(
        Path("feature_foundation/outputs/btc_market_daily.csv"),
        "--btc-market",
        help="BTC market daily CSV path.",
    ),
    transmission: Path = typer.Option(
        Path("feature_foundation/outputs/transmission_features_daily.csv"),
        "--transmission",
        help="Transmission features daily CSV path.",
    ),
    output: Path = typer.Option(
        Path("feature_foundation/outputs/macro_features_daily.csv"),
        "--output",
        "-o",
        help="Output consolidated macro features CSV path.",
    ),
    audit_output: Path = typer.Option(
        Path("feature_foundation/outputs/macro_feature_audit.csv"),
        "--audit-output",
        help="Output macro feature audit CSV path.",
    ),
    latest_output: Path = typer.Option(
        Path("feature_foundation/outputs/macro_feature_latest_snapshot.csv"),
        "--latest-output",
        help="Output latest feature snapshot CSV path.",
    ),
    snapshot: Path = typer.Option(
        Path("feature_foundation/outputs/macro_snapshot_latest.json"),
        "--snapshot",
...
def build_macro_scores_command(
    ...
    output: Path = typer.Option(
        Path("feature_foundation/outputs/macro_scores_daily.csv"),
        "--output",
        "-o",
        help="Output macro scores CSV path.",
    ),
    contributions_output: Path = typer.Option(
        Path("feature_foundation/outputs/macro_score_contributions_daily.csv"),
        "--contributions-output",
        help="Output long-form score contributions CSV path.",
    ),
    audit_output: Path = typer.Option(
        Path("feature_foundation/outputs/macro_score_audit.csv"),
        "--audit-output",
        help="Output macro score audit CSV path.",
    ),
    latest_output: Path = typer.Option(
        Path("feature_foundation/outputs/macro_score_latest_snapshot.csv"),
        "--latest-output",
...
def update_score_dashboard(
    ...
    dashboard_output: Path = typer.Option(
        Path("monitoring/outputs/dashboard.html"),
        "--dashboard-output",
...
def build_market_regime_command(
    ...
    output: Path = typer.Option(
        Path("feature_foundation/outputs/market_regime_daily.csv"),
        "--output",
        "-o",
        help="Output market regime daily CSV path.",
    ),
    transitions_output: Path = typer.Option(
        Path("feature_foundation/outputs/market_regime_transitions.csv"),
        "--transitions-output",
        help="Output regime transitions CSV path.",
    ),
    audit_output: Path = typer.Option(
        Path("feature_foundation/outputs/market_regime_audit.csv"),
        "--audit-output",
        help="Output regime audit CSV path.",
    ),
    latest_output: Path = typer.Option(
        Path("feature_foundation/outputs/market_regime_latest_snapshot.csv"),
        "--latest-output",
...
def build_compact_dashboard_command(
    ...
    output: Path = typer.Option(
        Path("monitoring/outputs/dashboard_compact.html"),
        "--output",
        "-o",
...
def inspect_tga_account_types_command(
    ...
    output: Path = typer.Option(
        Path("feature_foundation/outputs/tga_account_type_summary.csv"),
        "--output",
        "-o",
